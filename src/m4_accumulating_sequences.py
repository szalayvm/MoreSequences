...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '7-8-9-10-11'
    actual = make_less_simple_string(7, 11)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        y_corner_1 = circles[k].center.y + circles[k].radius
        x_corner_1 = circles[k].center.x - circles[k].radius
        list = list + [rg.Rectangle(rg.Point(x_corner_1,y_corner_1),rg.Point(circles[k].center.x + circles[k].radius,circles[k].center.y - circles[k].radius))]
    return list
